...
<head>
    ...
    <style>
        * {
        ...
        .nav-link i {
            margin-right: 1rem; /* Increased margin to create more space between icon and text */
            width: 20px;
            text-align: center;
        }
...
<body>
    ...
    <div class="main-content">
        <div class="form-container">
            <h2>Add Property</h2>
            <form:form method="post" action="addproperty" modelAttribute="property">
            ...
            <a href="list" class="back-link">List Of Properties</a>
        </div>
    </div>
</body>
</html>